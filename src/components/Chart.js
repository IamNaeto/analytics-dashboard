...
const Charts = () => {
   return (
    <div className="bg-white h-96 w-auto xl:w-[750px] border border-[#EDF2F7] rounded-2xl dark:bg-coolors-gray p-5 text-[16px] ">
      <div className="flex justify-between">
        <p className="font-semibold">Sales Trends</p>
        <div className="flex items-center gap-3">
          <p>Sort by:</p>
          
          <select className="border border-[#EDF2F7] rounded-2xl py-1 px-2 outline-none cursor-pointer">
