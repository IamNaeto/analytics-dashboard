...
const Header = ({ menu, setMenu, theme }) => {
    ...
    return (
        <nav className={`fixed top-0 z-30 w-full ${theme === 'dark' ? 'bg-black' : 'bg-[#f7f8fa]'} py-4 px-4 flex flex-col xl:flex-row items-center justify-between border-2 ${theme === 'dark' ? 'border-black border-b-[#374151]' : 'border-[#f7f8fa] border-b-[#E5EAEF]'} backdrop-blur-2xl pr-auto md:pr-[100px] xl:pr-0 gap-4 xl:gap-0`}>
